...
if($name=="" or $email=="" or $tel==""){
    ...
    $to = "kuprianovpavel9@gmail.com"; /* Адрес, куда отправляем письма*/
    $subject = "Письмо обратной связи"; /*Тема письма*/
    ...
    /*ДЛЯ ОТЛАДКИ ВЫ МОЖЕТЕ ПРОВЕРИТЬ ПРАВИЛЬНО ЛИ ЗАПИСАЛИCЬ ДАННЫЕ ИЗ ПОЛЕЙ*/
    // print_r($message);
